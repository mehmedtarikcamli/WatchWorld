...
namespace Web.Services
{
    public class HomeViewModelService : IHomeViewModelService
    {
        ...
        public HomeViewModelService(IRepository<Product> productRepo, IRepository<Category> categoryRepo,
        ...
        public async Task<HomeViewModel> GetHomeViewModelAsync(int? categoryId, int? brandId, int pageId)
        {
            ...
            var specProductsPaginated = new CatalogFilterSpecification(categoryId, brandId, (pageId - 1) * Constants.ITEMS_PER_PAGE,
